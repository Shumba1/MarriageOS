...
// Canonical route tree aligned to the approved V1 architecture.
...
export const routeTree: RouteNode[] = [
  ...
  {
    id: 'guides', path: '/guides', title: 'Guides', shell: 'app', access: 'member', nav: 'guides', showTopBar: true, showBottomNav: true, showSideNav: true, showRightRail: true, indexable: false,
    children: [
      { id: 'guideDetail', path: '/guides/[slug]', title: 'Guide Detail', shell: 'app', access: 'member', nav: 'guides', showTopBar: true, showBottomNav: true, showSideNav: true, showRightRail: true, indexable: false },
    ],
  },
  {
...
export const primaryMemberNav = [
  ...
  { id: 'guides' as const, label: 'Guides', href: '/guides' },
...
export const repairCategories = [
  ...
  { slug: 'repair-desire', label: 'Repair Desire' },
  { slug: 'overload-life-phase', label: 'Overload & Life Phase' },
  { slug: 'threats-to-system', label: 'Threats To The System' },
